...
select_nom_region = st.sidebar.selectbox(
     "Région",
     options=df_region['LIBELLE'])
select_region = df_region.loc[df_region['LIBELLE'] == select_nom_region, 'REG'].iloc[0]
st.sidebar.write('Ma région :', select_region, select_nom_region)

#Département
df_departement = pd.read_csv("./departement2021.csv", dtype={"CHEFLIEU": str}, sep=",")
filt_departement = df_departement.loc[df_departement['REG'] == select_region, ['DEP', 'LIBELLE']]
nom_departement = st.sidebar.selectbox(
  "Département",
  options=filt_departement['LIBELLE'])
select_departement = filt_departement.loc[df_departement['LIBELLE'] == nom_departement, 'DEP'].iloc[0]
st.sidebar.write('Mon département :', select_departement, nom_departement)


#EPCI
df_epci = pd.read_csv("./EPCI.csv", sep=";")
df_epci = df_epci.loc[df_epci['DEP'] == select_departement, ['EPCI', 'LIBEPCI']]
nom_epci = st.sidebar.selectbox(
     "EPCI",
     options=pd.unique(df_epci['LIBEPCI']))
code_epci = df_epci.loc[df_epci['LIBEPCI'] == nom_epci, 'EPCI'].iloc[0]
st.sidebar.write('Mon EPCI :', code_epci, nom_epci)

#Commune
df_commune = pd.read_csv("./EPCI.csv", sep=";")
df_commune = df_commune.loc[df_commune['EPCI'] == code_epci, ['COM', 'LIBGEO']]
select_ville = st.sidebar.selectbox(
     "Commune",
     options=df_commune['LIBGEO'])
code_commune = df_commune.loc[df_commune['LIBGEO'] == select_ville, 'COM'].iloc[0]
st.sidebar.write('Ma commune:', code_commune, select_ville)
...
def niveau_vie_median_commune(fichier, nom_ville, annee) :
    ...
    return df2
nvm_ville =niveau_vie_median_commune("./revenu/revenu_commune/FILO" + select_annee + "_DISP_COM.csv",select_ville, select_annee)
...
def niveau_vie_median_region(fichier, nom_region, annee) :
    ...
    return df2
nvm_region =niveau_vie_median_region("./revenu/revenu_region/FILO" + select_annee + "_DISP_REG.csv",select_nom_region, select_annee)
...
df_2014 = df_2014.replace(',','.', regex=True)
df_2014 = df_2014.loc[df_2014["LIBGEO"]== select_nom_region]
nvm_2014 =df_2014.loc[:, 'Q214'].to_numpy()
indice_2014 = nvm_2014[0]
...
df_2015 = df_2015.replace(',','.', regex=True)
df_2015 = df_2015.loc[df_2015["LIBGEO"]== select_nom_region]
nvm_2015 =df_2015.loc[:, 'Q215'].to_numpy()
indice_2015 = nvm_2015[0]
...
df_2016 = df_2016.replace(',','.', regex=True)
df_2016 = df_2016.loc[df_2016["LIBGEO"]== select_nom_region]
nvm_2016 =df_2016.loc[:, 'Q216'].to_numpy()
indice_2016 = nvm_2016[0]
...
df_2017 = df_2017.replace(',','.', regex=True)
df_2017 = df_2017.loc[df_2017["LIBGEO"]== select_nom_region]
nvm_2017 =df_2017.loc[:, 'Q217'].to_numpy()
indice_2017 = nvm_2017[0]
...
df_2018 = df_2018.replace(',','.', regex=True)
df_2018 = df_2018.loc[df_2018["LIBGEO"]== select_nom_region]
nvm_2018 =df_2018.loc[:, 'Q218'].to_numpy()
indice_2018 = nvm_2018[0]

df_region_glob = pd.DataFrame(np.array([[indice_2014, indice_2015, indice_2016, indice_2017, indice_2018]]),
                   columns=['2014', '2015', '2016', '2017', '2018'], index=[select_nom_region])
...
df_2014 = df_2014.replace(',','.', regex=True)
df_2014 = df_2014.loc[df_2014["LIBGEO"]== select_ville]
nvm_2014 =df_2014.loc[:, 'Q214'].to_numpy()
indice_2014 = nvm_2014[0]
...
df_2015 = df_2015.replace(',','.', regex=True)
df_2015 = df_2015.loc[df_2015["LIBGEO"]== select_ville]
nvm_2015 =df_2015.loc[:, 'Q215'].to_numpy()
indice_2015 = nvm_2015[0]
...
df_2016 = df_2016.replace(',','.', regex=True)
df_2016 = df_2016.loc[df_2016["LIBGEO"]== select_ville]
nvm_2016 =df_2016.loc[:, 'Q216'].to_numpy()
indice_2016 = nvm_2016[0]
...
df_2017 = df_2017.replace(',','.', regex=True)
df_2017 = df_2017.loc[df_2017["LIBGEO"]== select_ville]
nvm_2017 =df_2017.loc[:, 'Q217'].to_numpy()
indice_2017 = nvm_2017[0]
...
df_2018 = df_2018.replace(',','.', regex=True)
df_2018 = df_2018.loc[df_2018["LIBGEO"]== select_ville]
nvm_2018 =df_2018.loc[:, 'Q218'].to_numpy()
indice_2018 = nvm_2018[0]

df_ville_glob = pd.DataFrame(np.array([[indice_2014, indice_2015, indice_2016, indice_2017, indice_2018]]),
                   columns=['2014', '2015', '2016', '2017', '2018'], index=[select_ville])
...
def IV_commune(fichier, code_ville, annee):
    ...
    df_iv = pd.DataFrame(data=IV, columns = ['Indice de vieillissement en ' + annee], index = [select_ville])
    return df_iv
...
def IV_epci(fichier, epci, annee):
    epci_select = pd.read_csv('./EPCI.csv', dtype={"COM": str, "DEP": str, "EPCI":str}, sep = ';')
    ...
    year = annee[-2:]
    df_epci_com = pd.merge(df[['COM', 'P' + year + '_POP0019', 'P' + year + '_POP65P']], epci_select[['COM','EPCI', 'LIBEPCI']],  on='COM', how='left')
...
if int(select_annee) < 2017:
    valeurs_dep_iv = IV_departement_M2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_departement,select_annee)
else :
    valeurs_dep_iv = IV_departement_P2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_departement,select_annee)
...
def IV_region_M2017(fichier, region, annee):
    ...
    year = annee[-2:]
    df_regions = df.loc[df["REG"]==str(region), 'P'+ year +'_POP0019' : 'P'+ year + '_POP65P']
    ...
    M20=Somme_M20.values[0]
    IV = round((P65 / M20)*100,2)
    df_reg = pd.DataFrame(data=IV, columns = ['Indice de vieillissement en ' + annee], index = [select_nom_region])
    return df_reg
...
def IV_region_P2017(fichier, region, annee):
    ...
    df_region = df_regions.loc[df_regions["REG"]==str(region), ['REG', 'COM','P'+ year +'_POP0019' , 'P'+ year + '_POP65P']]
...
if int(select_annee) < 2017:
    valeurs_reg_iv = IV_region_M2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_region,select_annee)
else :
    valeurs_reg_iv = IV_region_P2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_region,select_annee)
...
#RÉGION
#2014
valeur_iv_region_2014 = IV_region_M2017("./population/base-ic-evol-struct-pop-2014.csv",select_region,'2014')
indice_2014 = valeur_iv_region_2014['Indice de vieillissement en 2014'][0]
#2015
valeur_iv_region_2015 = IV_region_M2017("./population/base-ic-evol-struct-pop-2015.csv",select_region,'2015')
indice_2015 = valeur_iv_region_2015['Indice de vieillissement en 2015'][0]
#2016
valeur_iv_region_2016 = IV_region_M2017("./population/base-ic-evol-struct-pop-2016.csv",select_region,'2016')
indice_2016 = valeur_iv_region_2016['Indice de vieillissement en 2016'][0]
#2017
valeur_iv_region_2017 = IV_region_P2017("./population/base-ic-evol-struct-pop-2017.csv",select_region,'2017')
indice_2017 = valeur_iv_region_2017['Indice de vieillissement en 2017'][0]
#2018
valeur_iv_region_2018 = IV_region_P2017("./population/base-ic-evol-struct-pop-2018.csv",select_region,'2018')
...
#DÉPARTEMENT
#2014
valeur_iv_departement_2014 = IV_departement_M2017("./population/base-ic-evol-struct-pop-2014.csv",select_departement,'2014')
indice_2014 = valeur_iv_departement_2014['Indice de vieillissement en 2014'][0]
#2015
valeur_iv_departement_2015 = IV_departement_M2017("./population/base-ic-evol-struct-pop-2015.csv",select_departement,'2015')
indice_2015 = valeur_iv_departement_2015['Indice de vieillissement en 2015'][0]
#2016
valeur_iv_departement_2016 = IV_departement_M2017("./population/base-ic-evol-struct-pop-2016.csv",select_departement,'2016')
indice_2016 = valeur_iv_departement_2016['Indice de vieillissement en 2016'][0]
#2017
valeur_iv_departement_2017 = IV_departement_P2017("./population/base-ic-evol-struct-pop-2017.csv",select_departement,'2017')
indice_2017 = valeur_iv_departement_2017['Indice de vieillissement en 2017'][0]
#2018
valeur_iv_departement_2018 = IV_departement_P2017("./population/base-ic-evol-struct-pop-2018.csv",select_departement,'2018')
...
def part80_seules_com(fichier, code_commune, annee):
    ...
    df_Part_pers_80_seules = pd.DataFrame(data=part_80_seules, columns = ['Part des personnes de plus de 80 ans vivant seules ' + annee], index = [select_ville])
...
def part80_seules_epci(fichier, epci, annee):
    ...
    year = annee[-2:]
    df_epci_com = pd.merge(df[['COM', 'P' + year + '_POP80P', 'P' + year + '_POP80P_PSEUL']], epci_select[['COM','EPCI', 'LIBEPCI']],  on='COM', how='left')
...
if int(select_annee) < 2017:
    valeurs_dep_iv = part80_seules_departement_M2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_departement,select_annee)
else :
    valeurs_dep_iv = part80_seules_departement_P2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_departement,select_annee)
...
def IV_region_M2017(fichier, region, annee):
    ...
    P80_seules=Somme_P80_seules.values[0]
    part_80_seules = round((P80_seules / P80)*100,0)
    df_reg = pd.DataFrame(data=part_80_seules, columns = ['Part des personnes de plus de 80 ans vivant seules ' + annee], index = [select_nom_region])
    return df_reg
...
if int(select_annee) < 2017:
    valeurs_reg_iv = IV_region_M2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_region,select_annee)
else :
    valeurs_reg_iv = IV_region_P2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_region,select_annee)
...
#RÉGION
#2014
valeur_part80_seules_region_2014 = IV_region_M2017("./famille/base-ic-couples-familles-menages-2014.csv",select_region,'2014')
indice_2014 = valeur_part80_seules_region_2014['Part des personnes de plus de 80 ans vivant seules 2014'][0]
#2015
valeur_part80_seules_region_2015 = IV_region_M2017("./famille/base-ic-couples-familles-menages-2015.csv",select_region,'2015')
indice_2015 = valeur_part80_seules_region_2015['Part des personnes de plus de 80 ans vivant seules 2015'][0]
#2016
valeur_part80_seules_region_2016 = IV_region_M2017("./famille/base-ic-couples-familles-menages-2016.csv",select_region,'2016')
indice_2016 = valeur_part80_seules_region_2016['Part des personnes de plus de 80 ans vivant seules 2016'][0]
#2017
valeur_part80_seules_region_2017 = IV_region_P2017("./famille/base-ic-couples-familles-menages-2017.csv",select_region,'2017')
...
df_region_glob = pd.DataFrame(np.array([[indice_2014, indice_2015, indice_2016, indice_2017]]),
                   columns=['2014', '2015', '2016', '2017'], index=[select_nom_region])

#DÉPARTEMENT
#2014
valeur_part80_seules_departement_2014 = part80_seules_departement_M2017("./famille/base-ic-couples-familles-menages-2014.csv",select_departement,'2014')
indice_2014 = valeur_part80_seules_departement_2014['Part des personnes de plus de 80 ans vivant seules 2014'][0]
#2015
valeur_part80_seules_departement_2015 = part80_seules_departement_M2017("./famille/base-ic-couples-familles-menages-2015.csv",select_departement,'2015')
indice_2015 = valeur_part80_seules_departement_2015['Part des personnes de plus de 80 ans vivant seules 2015'][0]
#2016
valeur_part80_seules_departement_2016 = part80_seules_departement_M2017("./famille/base-ic-couples-familles-menages-2016.csv",select_departement,'2016')
indice_2016 = valeur_part80_seules_departement_2016['Part des personnes de plus de 80 ans vivant seules 2016'][0]
#2017
valeur_part80_seules_departement_2017 = part80_seules_departement_P2017("./famille/base-ic-couples-familles-menages-2017.csv",select_departement,'2017')
...
df_commune_glob = pd.DataFrame(np.array([[indice_2014, indice_2015, indice_2016, indice_2017]]),
                   columns=['2014', '2015', '2016', '2017'], index=[select_ville])
...
def part_remplacement_com(fichier, code_commune, annee):
    ...
    df_part_remplacement = pd.DataFrame(data=part_remplacement, columns = ['Indice de renouvellement des générations âgées ' + annee], index = [select_ville])
...
def part_remplacement_epci(fichier, epci, annee):
    ...
    df = pd.read_csv(fichier, dtype={"IRIS": str, "TYP_IRIS": str, "MODIF_IRIS": str,"COM": str, "LAB_IRIS": str, "DEP": str, "UU2010": str, "GRD_QUART": str}, encoding= 'unicode_escape', sep = ';')
    year = annee[-2:]
    df_epci_com = pd.merge(df[['COM', 'P' + year + '_POP6074', 'P' + year + '_POP75P']], epci_select[['COM','EPCI', 'LIBEPCI']],  on='COM', how='left')
...
if int(select_annee) < 2017:
    indice_remplacement_dep = part_remplacement_M2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_departement,select_annee)
else :
    indice_remplacement_dep = part_remplacement_P2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_departement,select_annee)
...
def part_remplacement_region_M2017(fichier, region, annee):
    ...
    P75 = Somme_P75.values[0]
    part_remplacement = round((P60 / P75),2)
    df_reg = pd.DataFrame(data=part_remplacement, columns = ['Indice de renouvellement des générations âgées ' + annee], index = [select_nom_region])
    return df_reg
...
if int(select_annee) < 2017:
    indice_remplacement_reg = part_remplacement_region_M2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_region,select_annee)
else :
    indice_remplacement_reg = part_remplacement_region_P2017("./population/base-ic-evol-struct-pop-" + select_annee + ".csv",select_region,select_annee)
...
#RÉGION
#2014
valeur_part_remplacement_region_2014 = part_remplacement_region_M2017("./population/base-ic-evol-struct-pop-2014.csv",select_region,'2014')
indice_2014 = valeur_part_remplacement_region_2014['Indice de renouvellement des générations âgées 2014'][0]
#2015
valeur_part_remplacement_region_2015 = part_remplacement_region_M2017("./population/base-ic-evol-struct-pop-2015.csv",select_region,'2015')
indice_2015 = valeur_part_remplacement_region_2015['Indice de renouvellement des générations âgées 2015'][0]
#2016
valeur_part_remplacement_region_2016 = part_remplacement_region_M2017("./population/base-ic-evol-struct-pop-2016.csv",select_region,'2016')
indice_2016 = valeur_part_remplacement_region_2016['Indice de renouvellement des générations âgées 2016'][0]
#2017
valeur_part_remplacement_region_2017 = part_remplacement_region_P2017("./population/base-ic-evol-struct-pop-2017.csv",select_region,'2017')
...
#DÉPARTEMENT
#2014
valeur_part_remplacement_departement_2014 = part_remplacement_M2017("./population/base-ic-evol-struct-pop-2014.csv",select_departement,'2014')
indice_2014 = valeur_part_remplacement_departement_2014['Indice de renouvellement des générations âgées 2014'][0]
#2015
valeur_part_remplacement_departement_2015 = part_remplacement_M2017("./population/base-ic-evol-struct-pop-2015.csv",select_departement,'2015')
indice_2015 = valeur_part_remplacement_departement_2015['Indice de renouvellement des générations âgées 2015'][0]
#2016
valeur_part_remplacement_departement_2016 = part_remplacement_M2017("./population/base-ic-evol-struct-pop-2016.csv",select_departement,'2016')
indice_2016 = valeur_part_remplacement_departement_2016['Indice de renouvellement des générations âgées 2016'][0]
#2017
valeur_part_remplacement_departement_2017 = part_remplacement_P2017("./population/base-ic-evol-struct-pop-2017.csv",select_departement,'2017')
...
def part_fam_mono_com(fichier, code_commune, annee):
    ...
    df_Part_fam_mono = pd.DataFrame(data=part_fam_mono, columns = ['Part des familles monoparentales ' + annee], index = [select_ville])
...
if int(select_annee) < 2017:
    valeurs_fam_mono_dep = part_fam_mono_departement_M2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_departement,select_annee)
else :
    valeurs_fam_mono_dep = part_fam_mono_departement_P2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_departement,select_annee)
...
def part_fam_mono_region_M2017(fichier, region, annee):
    ...
    df_Part_familles_mono = pd.DataFrame(data=part_familles_mono, columns = ['Part des familles monoparentales ' + annee], index = [select_nom_region])
    return df_Part_familles_mono
...
if int(select_annee) < 2017:
    valeurs_fam_mono_reg = part_fam_mono_region_M2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_region,select_annee)
else :
    valeurs_fam_mono_reg = part_fam_mono_region_P2017("./famille/base-ic-couples-familles-menages-" + select_annee + ".csv",select_region,select_annee)
...
#RÉGION
#2014
valeur_part_fam_mono_region_2014 = part_fam_mono_region_M2017("./famille/base-ic-couples-familles-menages-2014.csv",select_region,'2014')
indice_2014 = valeur_part_fam_mono_region_2014['Part des familles monoparentales 2014'][0]
#2015
valeur_part_fam_mono_region_2015 = part_fam_mono_region_M2017("./famille/base-ic-couples-familles-menages-2015.csv",select_region,'2015')
indice_2015 = valeur_part_fam_mono_region_2015['Part des familles monoparentales 2015'][0]
#2016
valeur_part_fam_mono_region_2016 = part_fam_mono_region_M2017("./famille/base-ic-couples-familles-menages-2016.csv",select_region,'2016')
indice_2016 = valeur_part_fam_mono_region_2016['Part des familles monoparentales 2016'][0]
#2017
valeur_part_fam_mono_region_2017 = part_fam_mono_region_P2017("./famille/base-ic-couples-familles-menages-2017.csv",select_region,'2017')
...
#DÉPARTEMENT
#2014
valeur_part_fam_mono_departement_2014 = part_fam_mono_departement_M2017("./famille/base-ic-couples-familles-menages-2014.csv",select_departement,'2014')
indice_2014 = valeur_part_fam_mono_departement_2014['Part des familles monoparentales 2014'][0]
#2015
valeur_part_fam_mono_departement_2015 = part_fam_mono_departement_M2017("./famille/base-ic-couples-familles-menages-2015.csv",select_departement,'2015')
indice_2015 = valeur_part_fam_mono_departement_2015['Part des familles monoparentales 2015'][0]
#2016
valeur_part_fam_mono_departement_2016 = part_fam_mono_departement_M2017("./famille/base-ic-couples-familles-menages-2016.csv",select_departement,'2016')
indice_2016 = valeur_part_fam_mono_departement_2016['Part des familles monoparentales 2016'][0]
#2017
valeur_part_fam_mono_departement_2017 = part_fam_mono_departement_P2017("./famille/base-ic-couples-familles-menages-2017.csv",select_departement,'2017')
