...
def app():
  ...
  # nom_epci = df_epci.loc[df_epci['COM'] == code_commune, 'LIBEPCI'].iloc[0]
  # code_epci = df_epci.loc[df_epci['COM'] == code_commune, 'EPCI'].iloc[0]
  # st.sidebar.write('Mon EPCI 2023:', code_epci, nom_epci)
  #Département
